...
import com.tuju.x5webviewdemo.vassonic.SonicRuntimeImpl;
import com.tuju.x5webviewdemo.vassonic.SonicSessionClientImpl;

public class VasSonicActivity extends AppCompatActivity {
...
//        webView.addJavascriptInterface(new SonicJavaScriptInterface(sonicSessionClient, intent), "sonic");
    ...
    public static void loadUrl(Context context, String url) {
        Intent intent = new Intent(context, VasSonicActivity.class);
